...
from lerobot.common.envs.configs import LiberoEnv, MetaworldEnv
from lerobot.common.envs.factory import make_env_config, make_envs
...
class TestMakeEnv:
    ...
    def mock_env_config(self):
        ...
        config.import_name = "lerobot.common.envs.metaworld"
    ...
    @patch("lerobot.common.envs.factory.importlib.import_module")
    ...
    @patch("lerobot.common.envs.libero.LiberoEnv")
    ...
    def test_make_env_import_error_message(self, mock_env_config, mock_train_cfg):
        ...
        with patch("lerobot.common.envs.factory.importlib.import_module") as mock_import_module:
            mock_import_module.side_effect = ModuleNotFoundError("No module named 'test_module'")
...
class TestMakeEnvIntegration:
    ...
    @patch("lerobot.common.envs.factory.importlib.import_module")
    @patch("lerobot.common.envs.factory.gym.make")
    def test_make_env_gym_kwargs_from_real_config(
        ...
        # Mock SyncVectorEnv
        with patch("lerobot.common.envs.factory.gym.vector.SyncVectorEnv") as mock_sync_vector:
            mock_vector_env = Mock()
            mock_sync_vector.return_value = mock_vector_env
