...
from opentau.policies.tau0.modeling_tau0 import (
    TAU0FlowMatching,
    TAU0Policy,
...
from opentau.utils.fake_tensor import FakeTensorContext, run_with_fake_tensor
...
class TestTAU0Policy:
    ...
    @patch("opentau.policies.tau0.modeling_tau0.TAU0FlowMatching")
    @patch("opentau.policies.tau0.modeling_tau0.AutoTokenizer")
    @run_with_fake_tensor
    ...
    @patch("opentau.policies.tau0.modeling_tau0.log_model_loading_keys")
    @run_with_fake_tensor
