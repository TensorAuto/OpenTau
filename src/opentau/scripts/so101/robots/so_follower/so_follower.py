...
from opentau.scripts.so101.cameras.utils import make_cameras_from_configs
from opentau.scripts.so101.decorators import check_if_already_connected, check_if_not_connected
from opentau.scripts.so101.motors import Motor, MotorCalibration, MotorNormMode
from opentau.scripts.so101.motors.feetech import (
    FeetechMotorsBus,
    OperatingMode,
)
...
class SOFollower(Robot):
    ...
    def get_observation(self) -> RobotObservation:
        ...
        # num_retry: CH343 adapters intermittently drop a status packet; retry
        # instead of killing the session (see so_leader.get_action).
