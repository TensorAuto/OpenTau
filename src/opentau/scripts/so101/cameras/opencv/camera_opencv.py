...
from opentau.scripts.so101.errors import DeviceNotConnectedError
...
class OpenCVCamera(Camera):
    ...
    Example:
        ```python
        from opentau.scripts.so101.cameras.opencv import OpenCVCamera
        from opentau.scripts.so101.cameras.configuration_opencv import OpenCVCameraConfig
